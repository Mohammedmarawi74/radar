...
export const DATA_ANGLES: DataAngle[] = [
  {
    ...
    badge: 'فرصة عالية',
    color: 'blue',
    explanation: 'بيانات حجم الطلب على الخدمات والمنتجات في كل منطقة، عدد الطلبات المكتملة وغير المخدومة، تاريخ الطلب، القطاع التجاري، نوع الخدمة أو المنتج، إحصائيات النقص في التغطية، مؤشرات النمو',
    insightSummary: 'أكثر من 25% من طلبات الخدمات اللوجستية في المناطق الواعدة لا تزال غير ملباة بشكل كامل.',
    sources: ['وزارة التجارة', 'وزارة الشؤون البلدية'],
    fields: [
  ...
  },
  {
    ...
    badge: 'نمو سريع',
    color: 'green',
    explanation: 'بيانات السكان حسب العمر والجنس والمناطق، عدد السكان التجاريين، نسب النمو السنوي، تعداد السكان في المدن والمناطق الاقتصادية، عدد الأسر المستهلكة، بيانات سوق العمل',
  ...
  },
  {
    ...
    badge: 'قيمة عالية',
    color: 'amber',
    explanation: 'بيانات الرخص الإنشائية، عدد العقارات المباعة والمستأجرة، قيم العقارات، توزيع الأراضي حسب النشاط، إحصائيات العرض والطلب في المناطق المختلفة، مشاريع تطوير جديدة',
    insightSummary: 'هناك طلب متزايد على المساحات المكتبية في شمال الرياض يتجاوز المعروض الحالي بنسبة 12%.',
    sources: ['وزارة الإسكان', 'وزارة الشؤون البلدية', 'وزارة التجارة'],
    fields: [
  ...
  {
    id: 'emerging-regions',
    title: 'المناطق الاقتصادية الصاعدة',
    ...
    badge: 'رؤية 2030',
    color: 'indigo',
    explanation: 'بيانات مؤشرات النمو لكل منطقة، عدد المشاريع الاستثمارية، حجم الاستثمارات الجديدة، أعداد الشركات المسجلة حديثًا، بيانات البنية التحتية، مستوى الخدمات اللوجستية',
    insightSummary: 'المنطقة الشرقية سجلت أعلى معدل لنمو الشركات اللوجستية الجديدة هذا الربع بفضل التسهيلات الجديدة.',
    sources: ['الهيئة العامة للاستثمار', 'وزارة النقل', 'وزارة الاقتصاد والتخطيط'],
    fields: [
  ...
  },
  {
    ...
    badge: 'زخم عالٍ',
    color: 'emerald',
    explanation: 'بيانات نمو الإيرادات وعدد الشركات لكل قطاع، عدد الوظائف الجديدة، مؤشرات الطلب، نسب الاستثمار، الفجوات بين العرض والطلب',
  ...
  },
  {
    ...
    badge: 'تحليل المخاطر',
    color: 'rose',
    explanation: 'بيانات عدد الشركات القائمة في كل قطاع، الحصة السوقية لكل شركة، مؤشرات المنافسة، نسب العرض مقابل الطلب، بيانات أسعار المنتجات/الخدمات',
  ...
  },
  {
    ...
    badge: 'فرصة نادرة',
    color: 'purple',
    explanation: 'بيانات حجم الطلب غير المغطى، عدد العملاء المحتملين، مناطق الطلب الأعلى، عدد المنشآت والخدمات القائمة، مؤشرات فرص التوسع',
  ...
  },
  {
    ...
    badge: 'ذكاء مالي',
    color: 'cyan',
    explanation: 'بيانات المبيعات، عدد المستهلكين الفعليين، متوسط الإنفاق الفردي، تحليل المصروفات حسب القطاع، بيانات الفواتير والمعاملات الإلكترونية',
  ...
  },
  {
    ...
    badge: 'تحليل عميق',
    color: 'orange',
    explanation: 'بيانات تفضيلات المستهلكين، عدد المعاملات لكل فئة عمرية أو جغرافية، اتجاهات الشراء، تقييم رضا العملاء، بيانات البحث عن المنتجات والخدمات',
